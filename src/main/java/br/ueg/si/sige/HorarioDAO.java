...
public class HorarioDAO {
    ...
    public boolean incluir(Horario horario){
        ...
        try{
            ...
            if (i>0){
                db.createStatement();
                ResultSet rs = db.executeQuery("SELECT last_value from horarios_cd_horario_seq");
                rs.next();
                ...
                for (Iterator iter = horario.getItensHorario().iterator();iter.hasNext();){
    ...
    public boolean excluir(Horario horario){
        ...
        try{
            ...
            db.prepareStatement(
                    "DELETE FROM itenshorario WHERE cd_horario=?");
            db.setInt(1, horario.getCodigo());
            db.executeUpdate();
    ...
    public Horario buscaPorCodigo(int codigo){
        ...
        try{
            ...
            if (rs.next()){
                ...
                horario.setTurma(new TurmaDAO().buscaPorCodigo(rs.getInt("cd_turma")));
                horario.setItensHorario(new HashSet());
                rs.close();
       ...
       SigeDataBase db = new SigeDataBase();
        ...
        try{
           ...
           if (rs.next()){
                ...
                while (rs.next()){
                    Horario horario = this.buscaPorCodigo(rs.getInt("cd_horario"));
